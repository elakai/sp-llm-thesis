...
print("🚀 Booting up Headless Edge-Case Tester (Phase 5: Deception & Chaos)...")

with patch.object(st, 'session_state', mock_session_state):
    from src.core.retrieval import generate_response

    TEST_SUITES = {
        "1_THE_ANTI_SPECULATION_TEST": [
            # Verifies our nuclear Rule 13 patch killed the "let's assume" behavior.
            "If a subject meets twice a week, how many unexcused absences will automatically get me dropped from the class?"
        ],
    }

    output_file = "edge_case_phase5_results.md"

    with open(output_file, "w", encoding="utf-8") as f:
        f.write("# 🧪 AXIsstant Phase 5 Edge-Case Results\n\n")
    ...
    print(f"\n✅ Phase 5 testing complete! Check '{output_file}'.")